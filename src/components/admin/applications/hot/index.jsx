        ...
        data.push(
          {
            ...
            delete : (
                ...
                <button className={styles.button_table} value={elem.id} onClick={handleOpen2}>{t("appilcation.table.7")}</button>
                <button className={styles.button_update} value={elem.id}  onClick={handleOpen}>{t("appilcation.table.8")}</button>
                </div>
                ),
          }
        ):null)
