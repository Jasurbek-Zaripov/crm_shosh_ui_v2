...
function DemoChess() {
  ...
  const handleUpdate = async (evt) => {
    ...
    const data = {
      ...
      await axios.put(`https://api.hotelshoshmodern.uz/orders/${tempEvent.id}`, data)
  ...
  useEffect(() => {
    fetch("https://api.hotelshoshmodern.uz/rooms")
      .then((response) => response.json())
      .then((data) => setRooms(data));
  }, []);

  useEffect(() => {
    fetch("https://api.hotelshoshmodern.uz/orders")
      .then((response) => response.json())
  ...
  const HandleChange =  async(e) => {
    ...
    await axios.put(`https://api.hotelshoshmodern.uz/orders/${tempEvent.id}` , body)
     .then(res => res)
     window.location.reload();
  }
  ...
  const HandleOrderDelete = async() => {
   await axios.delete(`https://api.hotelshoshmodern.uz/deleteorders/${tempEvent.id}`)
   .then(res => res)
    window.location.reload()
  } 
  const HandleOrder = () =>{
