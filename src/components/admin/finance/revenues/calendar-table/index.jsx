...
const CalendarTable = () => {
  ...
  function sumOrders() {
    ...
    OrdersBusy.map((elem) =>
      ...
      elem.status_client == "active"
        ? (sum += Number(elem.definition))
        : 0
    );
      ...
      elem.filial?.filial_name == dataUser.filial.filial_name
        ? data.push({
              ...
              <NavLink
                ...
                to={
                  dataUser.role == "manager"
                    ? `/manager/room/${elem.orders
                        .map((e) =>
                          e.status == "busy" && e.status_client == "active"
                            ? e.id
                            : null
                        )
                        .filter(Boolean)
            ...
            tariff: (
              ...
              >
                {elem.orders
                  .map((e) =>
                    e.status == "busy" && e.status_client == "active"
                      ? Number(e.definition).toLocaleString()
                      : null
                  )
                  .filter(Boolean)
                  .join(", ")}
            ...
            accrued: (
              ...
              >
                {elem.orders
                  .map((e) =>
                    e.status == "busy" && e.status_client == "active"
                      ? Number(e.total_payable).toLocaleString()
                      : null
                  )
                  .filter(Boolean)
                  .join(", ")}
            ...
            paid: elem.orders
              ...
              .filter(Boolean)
              .join(", ") ? (
              <NavLink className={styles.tablinkActiveColor}>
                {elem.orders
                  .map((e) =>
                    e.status == "busy" && e.status_client == "active"
                      ? Number(e.paid).toLocaleString()
                      : null
                  )
                  .filter(Boolean)
                  .join(", ")}
            ...
            debtaccrual: elem.orders
              ...
              .join(", ") ? (
              <NavLink
                className={styles.tablinkActive}
                to={
                  dataUser.role == "manager"
                    ? `/manager/room/${elem.orders
                        .map((e) =>
